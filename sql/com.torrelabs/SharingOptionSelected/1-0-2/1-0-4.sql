...
--  obj_description
-- -----------------
--  iglu:com.torrelabs/SharingOptionSelected/jsonschema/1-0-2
--  (1 row)
...
BEGIN TRANSACTION;
  ...
  COMMENT ON TABLE atomic.com_torrelabs_sharing_option_selected_1 IS 'iglu:com.torrelabs/SharingOptionSelected/jsonschema/1-0-4';
