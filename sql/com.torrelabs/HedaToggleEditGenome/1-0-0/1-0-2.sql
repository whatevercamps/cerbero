...
--
-- SELECT pg_catalog.obj_description(c.oid) FROM pg_catalog.pg_class c WHERE c.relname = 'com_torrelabs_heda_toggle_edit_genome_1';
--  obj_description
-- -----------------
--  iglu:com.torrelabs/HedaToggleEditGenome/jsonschema/1-0-0
--  (1 row)

BEGIN TRANSACTION;

  ALTER TABLE atomic.com_torrelabs_heda_toggle_edit_genome_1
  ...
  COMMENT ON TABLE atomic.com_torrelabs_heda_toggle_edit_genome_1 IS 'iglu:com.torrelabs/HedaToggleEditGenome/jsonschema/1-0-2';
