...
CREATE TABLE IF NOT EXISTS atomic.com_torrelabs_user_applied_to_pokedex_application_2 (
...
COMMENT ON TABLE atomic.com_torrelabs_user_applied_to_pokedex_application_2 IS 'iglu:com.torrelabs/UserAppliedToPokedexApplication/jsonschema/2-0-0';
