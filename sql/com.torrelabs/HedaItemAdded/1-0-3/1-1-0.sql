...
--  obj_description
-- -----------------
--  iglu:com.torrelabs/HedaItemAdded/jsonschema/1-0-3
--  (1 row)

-- NO ADDED COLUMNS CAN BE EXPRESSED IN SQL MIGRATION

  COMMENT ON TABLE atomic.com_torrelabs_heda_item_added_1 IS 'iglu:com.torrelabs/HedaItemAdded/jsonschema/1-1-0';
