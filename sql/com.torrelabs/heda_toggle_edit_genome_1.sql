...
CREATE TABLE IF NOT EXISTS atomic.com_torrelabs_heda_toggle_edit_genome_1 (
    ...
    "source"             VARCHAR(10000) ENCODE ZSTD      NOT NULL,
    "value"              BOOLEAN        ENCODE RUNLENGTH NOT NULL,
...
ALTER TABLE atomic.com_torrelabs_heda_toggle_edit_genome_1 OWNER TO storageloadersnowcat;
