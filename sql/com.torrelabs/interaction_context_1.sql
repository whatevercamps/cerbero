...
CREATE TABLE IF NOT EXISTS atomic.com_torrelabs_interaction_context_1 (
...
COMMENT ON TABLE atomic.com_torrelabs_interaction_context_1 IS 'iglu:com.torrelabs/InteractionContext/jsonschema/1-0-0';
