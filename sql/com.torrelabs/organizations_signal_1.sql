...
CREATE TABLE IF NOT EXISTS atomic.com_torrelabs_organizations_signal_1 (
    ...
    "organization_name"      VARCHAR(10000) ENCODE ZSTD      NOT NULL,
    "organization_public_id" VARCHAR(10000) ENCODE ZSTD      NOT NULL,
...
COMMENT ON TABLE atomic.com_torrelabs_organizations_signal_1 IS 'iglu:com.torrelabs/OrganizationsSignal/jsonschema/1-0-0';

ALTER TABLE atomic.com_torrelabs_organizations_signal_1 OWNER TO storageloadersnowcat;
