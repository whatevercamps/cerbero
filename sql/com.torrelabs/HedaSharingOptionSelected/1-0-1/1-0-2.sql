...
--  obj_description
-- -----------------
--  iglu:com.torrelabs/HedaSharingOptionSelected/jsonschema/1-0-1
--  (1 row)
...
BEGIN TRANSACTION;
  ...
  COMMENT ON TABLE atomic.com_torrelabs_heda_sharing_option_selected_1 IS 'iglu:com.torrelabs/HedaSharingOptionSelected/jsonschema/1-0-2';
