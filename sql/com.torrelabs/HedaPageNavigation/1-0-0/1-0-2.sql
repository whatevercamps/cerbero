...
--  obj_description
-- -----------------
--  iglu:com.torrelabs/HedaPageNavigation/jsonschema/1-0-0
--  (1 row)

BEGIN TRANSACTION;

  ALTER TABLE atomic.com_torrelabs_heda_page_navigation_1
  ...
  COMMENT ON TABLE atomic.com_torrelabs_heda_page_navigation_1 IS 'iglu:com.torrelabs/HedaPageNavigation/jsonschema/1-0-2';
