...
CREATE TABLE IF NOT EXISTS atomic.com_torrelabs_filters_job_search_1 (
    ...
    "filter_enabled" BOOLEAN       ENCODE RUNLENGTH NOT NULL,
    "filter_name"    VARCHAR(50)   ENCODE ZSTD      NOT NULL,
