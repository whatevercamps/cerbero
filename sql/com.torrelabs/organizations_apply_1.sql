...
CREATE TABLE IF NOT EXISTS atomic.com_torrelabs_organizations_apply_1 (
    ...
    "organization_name"      VARCHAR(10000) ENCODE ZSTD,
    "organization_public_id" VARCHAR(10000) ENCODE ZSTD,
...
ALTER TABLE atomic.com_torrelabs_organizations_apply_1 OWNER TO storageloadersnowcat;
